...
const Index = () => {
  ...
  const [newForm, setNewForm] = useState({ name: "", company_name: "", phone: "", emails: [""], address: "",front_card: null, back_card: null});
...
const handleAddContact = async () => {
  ...
  if (!newForm.name.trim() || validEmails.length === 0) return;
  ...
  formData.append("phone", newForm.phone);
  ...
  setNewForm({ name: "", company_name: "", phone: "", emails: [""], address: "", front_card: null, back_card: null });
  setIsAdding(false);
  ...
  <label style={{
    ...
    <input
      ...
      onChange={(e) => {
        ...
        if (file) setNewForm({ ...newForm, front_card: file });
      }}
    />
    {newForm.front_card ? (
      <>
        <img
          src={URL.createObjectURL(newForm.front_card)}
          alt="Front Card"
...
<div>
  ...
  <label style={{
    ...
    <input
      ...
      onChange={(e) => {
        const file = e.target.files[0];
        if (file) setNewForm({ ...newForm, back_card: file });
      }}
    />
    {newForm.back_card ? (
      <>
        <img
          src={URL.createObjectURL(newForm.back_card)}
          alt="Back Card"
          style={{ width: "100%", maxHeight: 100, objectFit: "cover", borderRadius: 6 }}
        />
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
            ...
            <button
              onClick={() => {
                ...
                setSelected(null);
                setForm(null);
                setNewForm({ name: "", company_name: "", phone: "", emails: [""], address: "" });
              }}
