...
import { Users, CreditCard, QrCode, UserPlus, X } from "lucide-react";
...
function AddAdminModal({ onClose }) {
  ...
  const handleAdd = async () => {
    ...
    try {
      ...
      if (res.ok) { setMessage("Admin added successfully!"); setEmail(""); setPassword(""); }
      else { setError(data.error || "Failed to add admin."); }
...
export default function App() {
  const [loggedIn, setLoggedIn] = useState(!!localStorage.getItem("isAdmin"));
